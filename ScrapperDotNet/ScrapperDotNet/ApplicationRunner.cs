...
namespace ScrapperDotNet
{
    public class ApplicationRunner(ILogger<ApplicationRunner> logger, IDownloadService downloadService, IBrowserRunnerAsync browser, IAddressService addressService, IAiClient ollamaClient, IPageParser pageParser) : IApplicationRunner
    {
        ...
        public void Run()
        {
            logger.LogInformation($"Scrapper app {VersionInfo.VersionWithBuildDate} has started");
            Console.WriteLine($"ScrapperDotNet {VersionInfo.VersionWithBuildDate}");
        ...
        {
            Console.WriteLine("\nScrapperDotNet Version Information:");
